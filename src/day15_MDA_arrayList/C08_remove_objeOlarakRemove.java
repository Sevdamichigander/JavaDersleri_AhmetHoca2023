...
public class C08_remove_objeOlarakRemove {
    public static void main(String[] args) {
        ...
        // once silmek istediginiz objeyi olusturup sonra
        // Integer degeri degil, obje ismini yazarak remove edebilirsiniz
        /*
        Eger silmek istedigimiz obje birden fazla ise ilkini siler.
         */
