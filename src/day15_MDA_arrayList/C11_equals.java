...
public class C11_equals {
    public static void main(String[] args) {
        ...
        System.out.println(isimler1);// [Selgun, Saida, Sevda, Saida, Selgun, Sevda]
        ...
        /*
        Arraylist bir collection oldugu icin sort methodunu ordan kullanir.
        Burda isimleri siraladiktan sonra karsilastirdik.
         */
