...
public class C05_toLowerCse_toUpperCase {
    public static void main(String[] args) {
        ...
        // orijinal str hala eski olusturdugumuz haliyle. Cunku atama yapmadik.

        // str'i buyuk harfle yazilmis haline donusturun
        str = str.toUpperCase();
        System.out.println(str);// Simdi str kalici olarak buyuk hale dondu.
