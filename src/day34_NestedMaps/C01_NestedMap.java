...
public class C01_NestedMap {
    public static void main(String[] args) {
        ...
        /*
            ...
            Bunun yerine eger bilgilere erisim ve update in daha hizli yapilabilmesini istersek
            ...
            Bi tane ogrenci map im olacak. Bir de onun icinde map ler olacak.

            ogrenciMap = {101={ogrenciBilgiMap1},{ogrenciBilgiMap2},{ogrenciBilgiMap3}}
        ...
        System.out.println(ogrenciBilgiMapi101); //{sinif=11, sube=H, soyisim=Can, brans=MF, isim=Ali}

        //101 numarali ogrencinin bilgilerini iceren map i yazdirin

        System.out.println(ogrenciMap.get(101)); //{sinif=11, sube=H, soyisim=Can, brans=MF, isim=Ali}
