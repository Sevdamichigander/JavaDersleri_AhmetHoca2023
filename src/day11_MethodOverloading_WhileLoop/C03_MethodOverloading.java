...
public class C03_MethodOverloading {
    public static void main(String[] args) {
        ...
        Bi class ta ayni isme sahip birden fazla method olmasina denir.

        Java da bir class icerisinde ayni isim, ayni sayida ve data turunde parametre ile olusturulursa
        Java CTE verir(altini kirmizi cizer)

        Bunun 3 cozumu vardir:
        1- paramatre sayisi degistirilebilir
        2- parametrelerin data turleri degistirilebilir
        3- farkli data turunde parametrelerin yeri degistirilebilir

        Java bir method call oldugunda ayni isimdeki birden fazla methoddan hangisinin calisacagini belirlemek icin
